...
const Home = ({ clotheDisplayImg }) => {
  ...
  }, [index, clotheDisplayImg.length]);

  return (
    <div
      id="homepage"
      className="bg-[#E0B5DD] w-full p-10 flex flex-col justify-center items-center"
    >
      <div className="w-full p-10 flex justify-center items-center">
        <div className="flex flex-col gap-3 max-w-[616px] max-h-[315px] justify-between mx-20">
          ...
          <div className="flex gap-[16px]">
            <button className="p-3 bg-black hover:bg-zinc-800 transition-colors duration-300 ease-out cursor-pointer text-white max-w-[89px]">
              Shop
            </button>
            <button className="bg-gray-100 hover:bg-gray-200 transition-colors duration-300 ease-out cursor-pointer max-w-[139px]">
              Learn More
            </button>
          </div>
        </div>
        <div className="flex flex-col gap-2 justify-center items-center max-h-full max-w-[616px]">
          <img
            src={clotheDisplayImg[index].url}
            alt=""
            className="w-fit max-h-[80vh] object-cover rounded-xl shadow-2xl mx-28 hover:scale-105 transition-transform duration-500 ease-out cursor-pointer animate-fade-up animate-once animate-ease-in -translate-y-3"
          />
          <div className="flex gap-3 -translate-y-1 ">
            ...
            <button
              onClick={() =>
                setIndex(
                  (prevIndex) => (prevIndex + 1) % clotheDisplayImg.length
                )
              }
